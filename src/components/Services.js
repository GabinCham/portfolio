...
import "../styles/Services.css"; // Assurez-vous de modifier le chemin selon votre configuration
...
export default function ImageGallery() {
  ...
  const images = [
    {
      src: '/assets/brands_projet/peugeot-him-low-min.webp',
    ...
    {
      src: '/assets/brands_projet/orro_2-min.webp',
      title: 'ORRO EP',
    ...
    {
      src: '/assets/brands_projet/204-min.png',
      title: 'WAM CLOTHING',
    ...
    {
      src: '/assets/brands_projet/dyson-tournage-low-min.webp',
      title: 'DYSON',
      description: 'Video',
    ...
    {
      src: '/assets/brands_projet/dyson.webp',
      title: 'Galaxy',
    },
  ];
